...
const Sidebar = ({ menuItems, selectedMenu, onMenuSelect, userType }) => {
  ...
  return (
    <div className="w-64 bg-dark-800 border-r border-dark-700 h-screen flex flex-col fixed left-0 top-0">
      {/* Logo Section */}
